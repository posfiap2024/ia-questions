...
5. Inclua APENAS UMA resposta certa no questionário, não deve haver mais de uma opção correta por pergunta;
6. Para perguntas dissertativas, inclua o que é esperado que o aluno desenvolva na resposta;
7. Revise o questionário para garantir precisão e relevância, ajustando o que for necessário;
...
CRÍTICO: SEMPRE retorne as questões no formato esperado.
`
...
function transformQuestions(json: ElementCompact) {
